...
var MaskedInput = React.createClass({
  ...
  render: function render() {
    ...
    var isRevealingMask = _props2.isRevealingMask;
    var backspaceSkipsStatic = _props2.backspaceSkipsStatic;

    var cleanedProps = _objectWithoutProperties(_props2, ['reference', 'placeholderChar', 'formatCharacters', 'isRevealingMask', 'backspaceSkipsStatic']);
